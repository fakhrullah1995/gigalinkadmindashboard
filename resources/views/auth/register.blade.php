          ...
          <div class="column is-one-third is-offset-one-third m-t-100">
            <div class="card">
              <div class="card-content">
                <h1 class="title has-text-centered">Register new Admin</h1>
              ...
              <div class="column">
                <div class="field">
                  ...
                  <p class="control">
                    <input class="input {{$errors->has('password-confirm') ? 'is-danger' : ''}}" type="password-confirm" name="password-confirm" id="password-confirm" required>
                  </p>
