...
@section('content')
    <div class="flex-container">
        <div class="columns m-l-100 m-t-50">
            <div class="column">
        ...
        <form action="{{route('users.store')}}" method="POST">
            ...
            <div class="field">
                ...
                <p class="control">
                        ...
                        {{--  <input type="text" id="password" class="input" name="password" v-if="!auto_password" placeholder="Put password here">
                        <input type="checkbox" id="passwordbox">  --}}
                </p>
            </div>
